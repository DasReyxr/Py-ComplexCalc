...
% Arial 11, sin dos puntos, punto únicamente al final, centrado
\DeclareCaptionFont{arial11}{\fontsize{11}{13}\selectfont}
\DeclareCaptionFormat{puntofinal}{#1#2#3.}
\captionsetup{
  font=arial11,
  labelfont=arial11,
  labelsep=space,
...
\newcommand{\fuente}[1]{{\setstretch{1.15}\raggedleft\fontsize{9}{11}\selectfont\itshape Fuente: #1\par}}
